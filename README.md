...
5. **After phone call, make sure to kill and stop the app** by pressing ```Ctrl+c```. Current version offers no security so anyone knows your twilio number can use it.
